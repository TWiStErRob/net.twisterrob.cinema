...
@file:DependsOn("io.ktor:ktor-client-java-jvm:2.3.1")
@file:DependsOn("io.ktor:ktor-client-content-negotiation-jvm:2.3.1")
@file:DependsOn("io.ktor:ktor-serialization-jackson-jvm:2.3.1")
