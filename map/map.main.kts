...
@file:DependsOn("io.ktor:ktor-client-java-jvm:2.2.4")
@file:DependsOn("io.ktor:ktor-client-content-negotiation-jvm:2.2.4")
@file:DependsOn("io.ktor:ktor-serialization-jackson-jvm:2.2.4")
