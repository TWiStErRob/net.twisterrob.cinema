...
@file:DependsOn("io.ktor:ktor-client-java-jvm:3.6.0")
@file:DependsOn("io.ktor:ktor-client-content-negotiation-jvm:3.6.0")
@file:DependsOn("io.ktor:ktor-serialization-jackson-jvm:3.6.0")
...
@file:DependsOn("com.sun.xml.bind:jaxb-impl:4.0.9")
