...
public class CineworldPerformance extends CineworldBase {
	...
	/**
	 * <p>
	 * The booking url returned in the JSON response can be used to access the booking page with prepopulated film,
	 * cinema, date and time information. We use the key parameter to track the number of hits that you direct to the
	 * booking page.
	 * </p>
	 * <p>
	 * If you would like us to be able to track specific campaigns that you will run, you need to append another
	 * parameter called campaign to the booking url as shown below.
	 * 
	 * <pre>
	 ...
	 * </p>
	 * <p>
	 * This campaign identifier can be any string you like and you don't need to register this with us.
	 * </p>
	 * 
