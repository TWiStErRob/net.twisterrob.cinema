...
public class CinemasRequest extends BaseListRequest<CineworldCinema> {
	...
	public CinemasRequest(final String key, final String territory, final String callback, final Boolean full,
			final List<Integer> film, final List<Integer> date, final List<Integer> cinema,
	...
	@Override
	public URL getURL() {
		return BaseListRequest.makeUrl(CinemasRequest.REQUEST_URI,
	...
	public String getRequestType() {
		return CinemasRequest.REQUEST_TYPE;
	}
