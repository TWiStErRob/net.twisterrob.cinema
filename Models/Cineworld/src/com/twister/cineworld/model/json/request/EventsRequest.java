...
/**
 * <p>
 * This query returns a list of the current events being run by Cineworld. For example the
 * Edinburgh Film Festival will appear as an event, and all films being shown at the event
 * could be retrieved by using the event parameter.
 * </p>
 * <p>
 * Example request:<br>
...
public class EventsRequest extends BaseListRequest<CineworldEvent> {
	 ...
	 * @see EventsResponse
	 */
	@Override public Class<EventsResponse> getResponseClass() {
