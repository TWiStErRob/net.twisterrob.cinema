...
public class PerformancesRequest extends BaseListRequest<CineworldPerformance> {
	 ...
	 * @param film (Required) Film EDI to retrieve performances for.
	 */
	public PerformancesRequest(final String key, final String territory, final String callback,
			final Integer cinema, final Integer film, final Integer date) {
	...
	@Override public URL getURL() {
		return makeUrl(REQUEST_URI, KEY_CINEMA, m_cinema, KEY_FILM, m_film, KEY_DATE, m_date);
	}
	 ...
	 */
	@Override public Class<PerformancesResponse> getResponseClass() {
