...
/**
 * <p>
 * This query returns a list of film categories used by cineworld. Categories are used to
 * conveniently group films together. The API will only return 'simple' categories, such
 * as 'Movies for Juniors', but not dynamically calculated categories, such as 'Now
 * Showing'.
 * </p>
 * <p>
 * Example request:<br>
...
public class CategoriesRequest extends BaseListRequest<CineworldCategory> {
	 ...
	 */
	@Override public Class<CategoriesResponse> getResponseClass() {
