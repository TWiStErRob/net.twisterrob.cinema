...
class FilmMapperTest {
	...
	private fun assertProperties(expected: DBFilm, actual: FrontendFilm) {
		...
		assertThat(actual.created, equalTo(expected._created))
		assertThat(actual.updated, equalTo(expected._updated))
		assertThat(actual.cineworldID, equalTo(expected.cineworldID))
		assertThat(actual.title, equalTo(expected.title))
		...
		assertThat(actual.posterUrl, equalTo(expected.poster_url))
		assertThat(actual.cineworldInternalID, equalTo(expected.cineworldInternalID))
		assertThat(actual.cert, equalTo(expected.cert))
		assertThat(actual.isIMAX, equalTo(expected.isIMAX))
		assertThat(actual.is3D, equalTo(expected.is3D))
		assertThat(actual.filmUrl, equalTo(expected.film_url))
		...
		assertThat(actual.created, equalTo(expected._created))
		assertThat(actual.updated, equalTo(expected._updated))
		assertThat(actual.className, equalTo(expected.className))
	}
}
