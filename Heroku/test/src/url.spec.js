...
describe('URL Hash', function () {
	...
	describe('Cinemas', function () {
		...
		it('should preselect cinemas', function () {
			...
			expectEach(app.cinemas.london.filter("Wood Green")).toBeSelected();
			expectEach(app.cinemas.london.filter("Wood Green", true)).not.toBeSelected();
	...
	describe('Films', function () {
		...
		it('should preselect films', function () {
			...
			expectEach(app.films.new.filter(/All Eyez On Me|Baby Driver/)).toBeSelected();
			expectEach(app.films.new.filter(/All Eyez On Me|Baby Driver/, true)).not.toBeSelected();
